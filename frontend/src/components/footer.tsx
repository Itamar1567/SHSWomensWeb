    ...
    <div className="footer-container container">
      <section className="extra-information-section">
        <div>
          ...
          <section className="icons-section">
            <a href="https://www.instagram.com/" target="_blank">
              <InstagramIcon className="follow-icon"></InstagramIcon>
            </a>
            <a href="https://x.com/" target="_blank">
              <XIcon className="follow-icon"></XIcon>
            </a>
          </section>
        </div>
        <div className="extra-nav">
          ...
          <Link to="/newsletter" className="basic-link">
            Newsletter
          </Link>
        ...
        <div>
          ...
          <a href="/privacyPolicy.html" target="_blank" className="basic-link">
            Privacy Policy
          </a>
        </div>
      </section>
